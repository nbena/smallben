...
//func (r *Repository2) PauseJobs(ctx context.Context, jobsToAdd []Job) error {
//	ids := GetIdsFromJobsList(jobsToAdd)
...
//func (r *Repository2) ResumeJobs(ctx context.Context, jobsToAdd []Job) error {
//	ids := GetIdsFromJobsList(jobsToAdd)
...
//	rawTests := make([]Job, len(jobsToAdd))
//	for i, test := range jobsToAdd {
//		rawTests[i] = test.job
//	}
//	return r.transactionUpdate(
